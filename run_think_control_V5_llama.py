...
OUT_JSONL = "r_math_llama_8B_seed3407_sat.jsonl"
...
FAST_STEP_R_THRESHOLD = 0.8   # R  → ， FAST
SLOW_STEP_R_THRESHOLD = 0.4   # R  → ， SLOW
...
def run_one_item_with_think_control(
    ...
    user_prompt = (
        ...
        f"{question}\n"
        +"Start in MIDDLE mode (normal step-by-step reasoning).\n"
        +"[MIDDLE_STEP]"
    )
...
def main():
    ...
    ap.add_argument("--model", type=str, default="Llama-3.1-Nemotron-Nano-8B-v1")
